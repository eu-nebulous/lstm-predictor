...
def main():
    ...
    print(os.listdir("."))
    os.chdir("/home/jmarchel/PycharmProjects/lstm/src/lstm")


LstmPredictorState.configuration_file_location = "/home/jmarchel/PycharmProjects/lstm/src/lstm/prediction_configuration.properties"
Utilities.load_configuration()
